...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  <div id="bottompage">Copyright &copy; <?php echo date('Y')?></div>  
  ...
  <script src="<?php echo base_path() . path_to_theme(); ?>/js/jquery-ui.js"></script>
  <script src="<?php echo base_path() . path_to_theme(); ?>/js/jquery-ui.multidatespicker.js"></script>
  
  
  
  <script>

    jQuery(document).ready("#cruiseKeyPop").popover({

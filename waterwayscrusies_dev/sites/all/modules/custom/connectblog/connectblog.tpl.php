...
<script>
    ...
    $(document).ready(function() {
        ...
        //        $('#bloguserEmail').click(function() {
        //            $(".loadergif").show();
        //            var blogemail = $('#bloguserEmail').val();
        //            var baseUrl = Drupal.settings.basePath;
        //            var params = 'email=' + blogemail;
        //            jQuery.ajax({
        //                type: "POST",
        //                cache: false,
        //                async: true,
        ...
        //                },
        //                success: function(response, status, req) {
        //                    $('#bloguserName').val(response.name).readonly;
        //
        //                },
        //                complete: function() {
        //                    $(".loadergif").hide();
...
// echo $server_url . $_SERVER['REQUEST_URI'];
// exit();
?>
    ...
    <div class="connectMain">
        ...
        <div class="row-fluid blogMain">
            ...
            <div class="span7">
                ...
                <div class="blogInner responsiveWeb">
                    ...
                    <div class="blogShare" id="shareBtn">
                        ...
                        <span class="blogShareInner st_sharethis_custom" st_url="<?php echo $server_url . '/connectblog'; ?>" >Share</span>
                    </div>
                    ...
                    <form class="blogCommentform">
                        ...
                        <span class="loadergif" style="display:none; margin: 0 auto; width: 15px;"><img src="<?php echo base_path() . path_to_theme(); ?>/images/status-active.gif" /></span>
                ...
                <div class="moreblogs">
                    ...
                    <div class="moreblogsInner" id="moreblogsInner">

(function(b) {
    var c = {dataType: "csv", csvDelimiter: ",", dataSrc: "", sortBy: -1, sortDirection: "asc", pageSize: 0, pagerSize: 3, currentPage: 1, statusText: "Showing {1} to {2} of {3}.", sorting: true, loader: "ajax-loader.gif", enableZebra: true, caseSensitive: false, globalFilter: "", filter: {}}, a = {init: function(e) {
            var d = b.extend(c, e);
...
//                    p.find("tr:last").append(b("<td/>").text(e[g[o]][l[n]]))
                    p.find("tr:last").append(b("<td/>").html(e[g[o]][l[n]]))
                }

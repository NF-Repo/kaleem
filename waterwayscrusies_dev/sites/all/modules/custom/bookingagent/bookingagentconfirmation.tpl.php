<?php
/*
 * To change thiss template, choose Tools | Templates
...
<div class="container confirmationWrapper">
    <div class="connectMain mobilebookingagentContainer">
        ...
        <?php drupal_set_title('');?>
         ...
         <div class="row-fluid responsiveWeb ">
            <div class="span8"><div class="ticketTitle">Confirmation</div>
            <div class="span4"></div>
        </div>
...
<!--        <div class="row-fluid shreBtnmargin responsiveWeb">
            <div class="span12">
                <div class="booknow share shareBtnWidth" id="shareBtn">
                    <span class="booknow-inner st_sharethis_custom" st_url="<?php echo "http://" . $_SERVER["SERVER_NAME"] . $_SERVER['REQUEST_URI']; ?>" displayText="Share" >Share</span>
                </div>
            </div>
        </div>-->
...
<!--        <div class="row-fluid responsiveWeb">
            ...
            <div class="span4" align="right"><h5><img src="<?php echo base_path().path_to_theme() ?>/images/fax-footer-icon.png" alt="Print" />&nbsp;&nbsp;<a href="#">PRINT CONFIRMATION</a></h5></div>
        </div>-->
        ...
        <div class="row-fluid confirmationContainer">
            ...
            <div class="span7 confirmationContainerleft">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <p class="bookingagentSubTitle">Thank you for using Waterways Cruises for your cruise experience!</p>
                        
                        
                        <h1 class="bookingagentheader1">Your Waterways Cruise <?php print $orderid;?></h1>
...
<!--                        <p>Please keep this number as your e-ticket for records only. <strong>You do not need to print your confirmation for boarding.</strong></p>-->
            ...
            <div class="span5 confirmationContainerright">
                ...
                <div class="row-fluid groupmarginTop">
                    <div class="span3"><img src="<?php echo base_path().path_to_theme() ?>/images/bookingagent-parking-logo.png" alt="Seattle" /></div>
                    <div class="span9 groupdirection">
                        <h5>Parking</h5>
                ...
                <div class="row-fluid groupmarginTop">
                    <div class="span3"><img src="<?php echo base_path().path_to_theme() ?>/images/bookingagent-faq-logo.png" alt="Seattle" /></div>
                    <div class="span9 groupdirection">
                        <h5>FAQ's</h5>
                        <p>Echo park iphone godard retro, ugh id neutrar.</p>
        ...
        <div class="row-fluid">
            <div class="span12">
                <h1 class="bookingagentheader1 textmarginTop">Ticket Details</h1>
            </div>
        </div>
        
        <div class="row-fluid">
            <div class="span7 bookingagentTicketDetails">
        ...
        <div class="row-fluid">
            <div class="span12" style="<?php echo $display; ?>">
...
<!--            <div class="span7">
                <div class="chargesWrapper bookingagentheader3">
                    <h3 class="chargesWrapperLeft bookingagentheader3">Voucher Codes:</h3><h4>&nbsp;&nbsp;94JQ-3F6N-GRF2R,RPGV-9LFR-YWYY</h4><span></span><h3 class="chargesWrapperRight bookingagentheader3">-$68.<sup>00</sup></h3>
                </div>
                <div class="chargesWrapper textmarginTop">
                    <h3 class="chargesWrapperLeft bookingagentheader3">Gratuity</h3><span></span><h3 class="chargesWrapperRight bookingagentheader3">$14.<sup>00</sup></h3>
                </div>
                <div class="chargesWrapper">
                    <h3 class="chargesWrapperLeft bookingagentheader3">Port Charge</h3><span></span><h3 class="chargesWrapperRight bookingagentheader3">$8.<sup>00</sup></h3>
                </div>
                <div class="chargesWrapper">
                    <h3 class="chargesWrapperLeft bookingagentheader3">Tax</h3><span></span><h3 class="chargesWrapperRight bookingagentheader3">$13.<sup>00</sup></h3>
                </div>
                <div class="chargesWrapper">
                    <h3 class="chargesWrapperLeft bookingagentheader3">Subtotal</h3><span></span><h3 class="chargesWrapperRight bookingagentheader3">$151.<sup>00</sup></h3>
                </div>
                <div class="row-fluid textmarginTop">
                    <div class="span12" align="right">
                        <span class="bookingagentheader1">Total</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="bookingagentheader1">$164.<sup>00</sup></span>
                    </div>
                </div>
            </div>-->
            <div class="span5 responsiveWeb"></div>
        ...
        <div class="row-fluid confirmPricingDetails">
            <div class="span7">
                <h1 class="bookingagentheader1">Payment Details</h1>

   ...
   $.extend($.ui, { multiDatesPicker: { version: "1.6.1" } });
    ...
    Drupal.behaviors.cruiseAjax = {
        attach: function(context, settings) {
            ...
            $('#edit-scheduleeventsdates').change(function() {
    ...
    Drupal.ajax.prototype.commands.changescheduledate = function(ajax, response, status) {
        // this will be executed after the ajax call
        $("#edit-scheduleeventsdates option:selected").each(function() {
            str = $(this).text() + " ";
        }); 
...
//        setdates = d1;   
         $('#with-altField').datepicker("destroy");
         $('#with-altField').multiDatesPicker('removeIndexes', 0);
    ...
    Drupal.ajax.prototype.commands.reloadafterdeleteevent = function(ajax, response, status) {
        // this will be executed after the ajax call
        var cruisetemplate_id=$("#cruisetemplate_id").val();
        var baseUrl = Drupal.settings.basePath;
        window.location = baseUrl+"cruise/"+cruisetemplate_id+"/schedule";
    }

})(jQuery);

 
//    $.fn.changescheduledate = function(data) {
//  // dialog ajax id
//  alert('test');
//};

//jQuery.fn.changescheduledate = function() {

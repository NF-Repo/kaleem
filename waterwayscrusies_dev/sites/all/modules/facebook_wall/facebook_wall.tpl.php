  ...
  ?>
    ...
    <div class="wallContent_right">
      ...
      <!-- Share link block : starts here ! -->
        <?php
          if (($facebook_wall->data[$i]->type == 'link' || $facebook_wall->data[$i]->type == 'video') && isset($facebook_wall->data[$i]->name)) :
        ...
        <div> 
          <?php 
            if (isset($facebook_wall->data[$i]->picture) && $facebook_wall->data[$i]->type == 'photo') :
              print '<a href="' . $facebook_wall->data[$i]->link . '"><img src="' .  $facebook_wall->data[$i]->picture . '"></a>';
            endif;
          ?>  
        </div>
        <!-- User Content block : ends here ! -->
          ...
          ?>
            <div class="likes">
              <?php
                ...
                if ($key < $facebook_wall->data[$i]->likes->count) :
                  print 'and <a href=' . $fb_post_link . '>' . ($facebook_wall->data[$i]->likes->count - $key) . ' others</a>';
                  print ' likes this.';
                endif;
              ?>
            </div>
        ...
        <?php
          ...
          if (isset($facebook_wall->data[$i]->comments->data)) :
            ...
            if ($count_comments > 0 && $facebook_wall->data[$i]->comments->count) :
        ?>
